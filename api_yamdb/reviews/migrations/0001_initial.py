# Generated by Django 3.2 on 2023-02-03 23:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, help_text='Укажите email пользователя', max_length=254, unique=True, verbose_name='Email')),
                ('bio', models.TextField(blank=True, help_text='Напишите биографию пользователя', verbose_name='Биография пользователя')),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('moderator', 'Moderator'), ('user', 'User')], default='user', help_text='Укажите роль пользователя', max_length=9, verbose_name='Роль пользователя')),
